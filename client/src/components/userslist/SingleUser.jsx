...
<Typography sx={{fontWeight:"bold"}}>Edit Profile {employeeData.name}</Typography>
<Typography sx={{cursor:"pointer"}} onClick={handleEditClose}><img src="/icons/editcrossbutton.png"></img></Typography>
       </Box>
       <Divider/>
       <Box sx={{display:"flex",justifyContent:"center",mt:3}}>
       <TextField value={editData.name} name="name" onChange={handleChange} sx={{width:"80%",}} id="Name" label="Name"  variant="outlined" size="small"/>
       </Box>
       <Box sx={{display:"flex",justifyContent:"center",mt:3}}>
       <TextField value={editData.email} name="email" onChange={handleChange} sx={{width:"80%",}} id="email" label="Email" variant="outlined" size="small" />
       </Box>
      {/* probaton */}
      ...
      <Stack spacing={3}  sx={{display: { width:"90%",xs: "flex", md: "none", lg: "none" }}} >
        ...
        {/* <Box > */}
        <Stack spacing={3}  sx={{width:"80%",display: { xs: "none", md: "flex", lg: "flex" },}}>
        <DesktopDatePicker
          label="Probation"
          format="MM/dd/yyyy"
          name="probation"
      ...
      <Box sx={{ display: "flex", justifyContent: "center", mt: 2 }}>
       ...
       <Box sx={{display:"flex",justifyContent:"center",mt:3}}>
       <Button variant="contained" sx={{backgroundColor:"#0A1833"}}
        // onClick={editHandler}
        onClick={()=>{userEditHandler(employeeData._id,editData,probationTime);handleEditClose()}} 
        >Edit User</Button>
       </Box>
     ...
     <Box sx={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          <Box sx={{ display: "flex", ml: 2 }}>
            ...
            <Typography sx={{ ml: 4,width:"270px" }}>{employeeData.name}</Typography>
          </Box>
          <Box sx={{ display: "flex", mr: 4 }}>
            ...
            <Typography sx={{ fontWeight: "bold",cursor:"pointer" }} onClick={ handleEditOpen}><img alt="edit" src="/icons/userlisteditbutton.png"></img></Typography>
          </Box>
        </Box>
      </Box>
    </>
